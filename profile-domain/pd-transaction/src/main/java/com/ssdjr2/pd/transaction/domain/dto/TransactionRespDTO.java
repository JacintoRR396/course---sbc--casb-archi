 ...
 * @version 1.0
 */
@Schema(name = "TransactionRespDTO", description = "DTO than represent a response about one transaction")
@Data
public class TransactionRespDTO implements Serializable {

	@Serial
	private static final long serialVersionUID = 8588887008548130226L;

	@Schema(name = "id", requiredMode = Schema.RequiredMode.REQUIRED, example = "1", defaultValue = "0", description = "Unique id of one transaction on database")
	private Long id;
